...
var counter_model_1 = require("../counter/counter.model");
var OrderHelper = /** @class */ (function () {
    function OrderHelper(order) {
        this.order = order;
    }
    OrderHelper.prototype.value = function () {
        return this.order;
    };
    OrderHelper.generateOrderCode = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, orderCounter
                                ...
                                .exec()
                                .then(function () {
                                return "BS".concat(orderCounter.value + 1);
                            })];
                }
            });
        });
